...
cmake . && make
cd python
python continue_sim.py halfshear-darcy-sigma0=20000.0-k_c=3.5e-13-mu=6.11e-07-velfac=1.0-shear 1 0 &
python continue_sim.py halfshear-darcy-sigma0=20000.0-k_c=3.5e-14-mu=1.797e-07-velfac=1.0-shear 1 1 &
